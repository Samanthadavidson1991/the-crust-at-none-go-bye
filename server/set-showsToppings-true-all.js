...
(async () => {
  ...
  const res = await MenuItem.updateMany({}, { $set: { showsToppings: true } });
  console.log('Updated menu items:', res.modifiedCount || res.nModified || res); // Support for different Mongoose versions
